// *******************************************************************************************************
// **                                                                                                   **
// **   24AA1025.v - Microchip 24AA1025 1M-BIT I2C SERIAL EEPROM (VCC = +1.7V TO +5.5V)                 **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M24AA1025 (A0, A1, A2, WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   initial $readmemh("i2c.mem",MemoryBlock,0,131071);
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SDA) begin
      if (SCL == 1) begin
          $display("BFM : Start bit being Detected");
         START_Rcvd <= 1;
         STOP_Rcvd  <= 0;
         CTRL_Rcvd  <= 0;
         ADHI_Rcvd  <= 0;
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SCL) begin
      if (ADLO_Rcvd & (BitCounter == 8)) begin
       ...
       $display("BFM : Coming into Write Data buffer");
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SCL) begin
       if (RdCycle) begin
          $display("BFM : Read Data Processing");
         if (BitCounter == 8) begin
            SDA_DO <= 0;
            SDA_OE <= 0;
         end
