...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter mem_file_name     = "s25fs512s.mem"; //"none";
...
///////////////////////////////////////////////////////////////////////////////
   ...
   begin: Buscycle
        ...
        begin                    // input are latched on the rising edge of SCK
            ...
            if (~CSNeg_ipd)
            begin
               // $display($time,"BFM: Coming here when Command is Executed");
                case (bus_cycle_state)
                    ...
                    begin
                        ...
                        begin
                            ...
                            $display($time, "\t BFM: Opcode is: %h",opcode);
                            case (opcode)

                                8'b00000001 : // 01h
                                begin
                                    $display("\t BFM: Write Volatile Config Reg1");
                                    Instruct = WRR;
                                ...
                                begin
                                    Instruct = WREN;
                                    bus_cycle_state = DATA_BYTES;
                                    $display($time,"\t BFM: Write Enable Detected");
                                end
                                ...
                                8'b01110001 : // 71h
                                begin
                                    $display("\t BFM: WRAR Command Detected");
                                    Instruct = WRAR;
                                    bus_cycle_state = ADDRESS_BYTES;
                                end
                                ...
                                begin
                                    ...
                                    //Command not supported in Quad All mode
                                        bus_cycle_state = STAND_BY;
                                        $display($time,"\t BFM: Not Supported QUAD ALL");
                                    end
                                    else
                                    begin
                                        bus_cycle_state = ADDRESS_BYTES;
                                        $display($time,"\t BFM: Command Read, Waiting for Address");
                                        CHECK_FREQ = 1'b1;
                                    end
                                end
                                ...
                                begin
                                    Instruct = RDID;
                                    bus_cycle_state = DATA_BYTES;
                                    $display("BFM: Read ID Command Detected");
                                end
                                ...
                                8'b11011100 : // DCh
                                begin
                                    $display("\t BFM: Sector Erase Command");
                                    Instruct = SE4;
                                    bus_cycle_state = ADDRESS_BYTES;
                                end
                    ...
                    ADDRESS_BYTES :
                    begin
                        $display($time, "\t BFM: Starting Address Read Phase");
                        if ((Instruct == DDRQIOR) || (Instruct == DDRQIOR4))
                            DOUBLE = 1'b1;
                        else
                            DOUBLE = 1'b0;
                        ...
                        //Instruction + 4 Bytes Address + Dummy Byte
                            ...
                            begin
                                ...
                                begin
                                    ...
                                    if (Latency_code == 0) begin
                                        bus_cycle_state = DATA_BYTES;
                                        $display($time,"\t BFM: Sending Data Bytes");
                                    end
                                    else begin
                                        bus_cycle_state = DUMMY_BYTES;
                                        $display($time,"\t BFM: Waiting for Dummy Bytes to be latched");
                                    end
                                end
                            end
                        end
                        ...
                        //QUAD I/O High Performance Read (3Bytes Address)
                            $display("\t BFM: Is Quad set? QIOR: %b",QUAD);
                            if (QUAD)
                            begin
                                Address_in[4*addr_cnt]   = RESETNeg_in;
                                Address_in[4*addr_cnt+1] = WPNeg_in;
                        ...
                        begin
                            ...
                            $display("\t BFM: Is Quad set? QIOR4: %b",QUAD);
                            if (QUAD)
                            begin
                                $display($time,"Are we coming here?");
                                Address_in[4*addr_cnt]   = RESETNeg_in;
                                Address_in[4*addr_cnt+1] = WPNeg_in;
                                Address_in[4*addr_cnt+2] = SO_in;
                                Address_in[4*addr_cnt+3] = SI_in;
                                ...
                                $display("BFM: Going to StandBy mode since QUAD bit is not set");
                                bus_cycle_state = STAND_BY;
                            end
                        end
                       ...
                       //Quad I/O DDR Read Mode (4 Bytes Address)
                        ...
                        $display($time,"\t BFM: Received Address is %h",Address_in);
                    ...
                    begin
                        ...
                        $display($time,"\t BFM: Beginning of Dummy Phase, Count: %d",dummy_cnt);
                        if (((Instruct==DDRQIOR) || (Instruct == DDRQIOR4)) &&
                    ...
                    DATA_BYTES :
                    begin
                        $display($time,"\t BFM: Beginning of Data_bytes phase");
                        if ((Instruct == DDRQIOR) || (Instruct == DDRQIOR4))
                        begin
                            read_out = 1'b1;
                            read_out <= #1 1'b0;
                            $display("BFM: What the hell is this? %h", read_out);
                        end
                ...
                case (bus_cycle_state)
                    ...
                    begin
                        ...
                        begin
                            read_out = 1'b1;
                            read_out <= #1 1'b0;
                            //$display($time,"BFM: Are we coming here at all read_out: %h",read_out);
                        end
                    end //end of DATA_BYTES
            ...
            begin
                ...
                case (Instruct)
                    ...
                    begin
                        ...
                        $display($time, "\t BFM: SR1_in: %h CR1_in: %h",SR1_in,CR1_in); 
                    end
                    ...
                    begin
                        ...
                        $display("\t BFM: WRAR Reg Value: %h",WRAR_reg_in);
                    end
                    ...
                    OTPP:
                    begin
                        $display($time,"BFM: Page Program Command");
                        if (~QUAD_ALL)
                        begin
                            if (data_cnt > 0)
                            begin
                        ...
                        $display($time,"BFM: Seems like some data has been written after all");
                    end
    ...
    begin: StateGen1
        ...
        begin
            case (current_state)
                ...
                IDLE :
                begin
                    $display($time,"BFM: The Instruct in Idle is : %h isWEL: %b",Instruct, WEL);
                    ...
                    begin
                        ...
                        begin
                            $display($time," BFM: Expecting the BFM to Come here");
                            ...
                            begin
                                next_state = PAGE_PG;
                                $display($time," BFM: Beginning of PAGE PROGRAM");
                            end
                            else begin
                                next_state = PGERS_ERROR;
                                $display($time," BFM: It's a Page Program Error because: Sec_Prot: %h PPB_bits: %h DYB_bits: %h",Sec_Prot[sect],PPB_bits[sect],DYB_bits[sect]);
                            end
                        end
                        ...
                        begin
                            $display("\t BFM: Sector Erase Coming");
                            ReturnSectorID(sect,Address);
                ...
                PGERS_ERROR :
                begin
                    $display($time,"\t BFM: It's a Page Program Error");
                    if (falling_edge_write)
                    begin
...
//    /////////////////////////////////////////////////////////////////////////
    ...
    integer sect;
        ...
        $display($time,"Current_state is : %d",current_state);
        case (current_state)
            IDLE :
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        $display($time,"BFM: Program Page");
                        if (Sec_Prot[sect] == 0 &&
                            PPB_bits[sect]== 1 && DYB_bits[sect]== 1)
                        begin
                            $display($time,"BFM: Program Page Begins");
                            PSTART  = 1'b1;
                            PSTART <= #5 1'b0;
                            PGSUSP  = 0;
                            PGRES   = 0;
                            ...
                            begin
                                if (Viol != 0)
                                    ...
                                    WData[i] = WByte[i];
                                    $display($time, "\t BFM: WData: %b",WData[i]);
                                end
                            end
                            $display($time, "\t BFM: Address is %h",Address);
                            //$display("\t BFM: Complet WData: %h",WData);
                        end
                        else
                        begin
                          $display($time,"BFM: Program Page Discarded due to Protected Main Memory Sector: Sec_prot[sect]: %b PPB_bits[sect]: %b DYB_bits: %b",Sec_Prot[sect],PPB_bits[sect],DYB_bits[sect]);
            ...
            WRITE_SR:
            begin
                $display($time,"SR is going to be written");
                if (QUAD_ALL)
                begin
                    rd_fast = 1'b1;
                    rd_slow = 1'b0;
                ...
                if (WDONE == 1)
                begin
                    $display($time,"\t BFM: WEL is unset when SR is being written");
                    SR1_V[0] = 1'b0; //WIP
                    SR1_V[1] = 1'b0; //WEL
                    ...
                    // the QUAD bit cannot be cleared to 0.
                        ...
                        $display($time,"BFM: CR1_V: %h",CR1_V);
                    end
                ...
                begin
                    ...
                    begin
                        ...
                        // CR2V[1]=1) the QUAD bit cannot be cleared to 0.
                            ...
                            $display("\t BFM: CR1_NV and CR1_V are getting updated");
                        end
            ...
            begin
                ...
                begin
                    $display($time,"\t BFM: Page Program Coming Here to update Mem");
                    if (~PDONE)
                    begin
                        $display($time,"\t BFM: What the hell is happening here");
                ...
                begin
                    SR1_V[0] = 1'b0; //WIP
                    SR1_V[1] = 1'b0; //WEL
                    $display($time,"\t BFM: Updating Memory");
                    for (i=0;i<=wr_cnt;i=i+1)
                    begin
                        Mem[Addr_tmp + i - cnt] = WData[i];
                        $display($time,"\t BFM: Addr_tmp: %d i: %d cnt: %d Mem[Addr_tmp+i-cnt]: %h WData[i]: %h",Addr_tmp,i,cnt,Mem[Addr_tmp+i-cnt],WData[i]);
            ...
            SECTOR_ERS:
            begin
                $display($time,"\t BFM: Sector Erase Command Starting");
                if (QUAD_ALL)
                begin
                    rd_fast = 1'b1;
                    rd_slow = 1'b0;
                ...
                begin
                    $display($time,"\t BFM: Hopefully Starting Erasure");
                    if (~EDONE)
                    begin
                        $display("\t BFM: Are we here?");
                        ADDRHILO_SEC(AddrLo, AddrHi, Addr);
                        for (i=AddrLo;i<=AddrHi;i=i+1)
                        begin
                            Mem[i] = -1;
                            $display($time,"\t BFM: Crazy level prints");
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    else if (Instruct == WREN) begin
                        $display($time,"BFM: Write Enable bit is being set in the SR1_V register");
                        SR1_V[1] = 1'b1; //WEL
                    end
                    else if (Instruct == CLSR)
                    begin
