  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  debug_printf ("Execution ends End Time: %d Start Time: %d User Time: %d \n",End_Time,Begin_Time, User_Time);
...
//  Microseconds1 = ((User_Time / Number_Of_Runs) * Mic_secs_Per_Second) / HZ;
//  Microseconds = (User_Time*Mic_secs_Per_Second*10ll) / (Number_Of_Runs* HZ * 10);
//  Dhrystones_Per_Second1 = (HZ * Number_Of_Runs) / User_Time;
//	printf("Microseconds1 for one run through Dhrystone: %ld\n",Microseconds1);
//	printf("Dhrystones1 per Second:                      %ld\n",Dhrystones_Per_Second1);

	printf("Microseconds for one run through Dhrystone: ");
	int64_t div1 = (int64_t)HZ*(int64_t)Number_Of_Runs;
	Microseconds = 10ll * (int64_t)User_Time * Mic_secs_Per_Second;
	printf ("%6d.%01d \n", Microseconds/(10*div1), (Microseconds%10));
